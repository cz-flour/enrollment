     ...
     <?php }?>
              <div class="row">
                ...
                <div class="col">
                  ...
                  <input type="text" class="form-control" placeholder="Enter middle name" id="mname" required>
                </div>
                <div class="col">
              ...
              <div class="row">
                <div class="col-4">
                  ...
                  <input type="tel" class="form-control" placeholder="Enter phone number" id="contact" required>
                </div>
              </div>
